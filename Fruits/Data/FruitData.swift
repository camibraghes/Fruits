...
let fruitsData: [Fruit] = [
    Fruit(title: "Blueberry",headline: "Blueberries are sweet, nutritious and wildly popular fruit all over the world.",image: "blueberry",gradientColor: [Color("ColorBlueberryLight"), Color("ColorBlueberryDark")],description: """
    ...
    Fruit(title: "Strawberry", headline: "Widely appreciated for its characteristic aroma,  red color, juicy texture, and sweetness.", image: "strawberry", gradientColor: [Color("ColorStrawberryLight"), Color("ColorStrawberryDark")],
        description: """
    ...
    Fruit(title: "Lemon", headline: "There's no doubt lemons are delicious, but does adding them to water make you healthier?", image: "lemon", gradientColor: [Color("ColorLemonLight"), Color("ColorLemonDark")],
        description: """
    ...
    Fruit(title: "Plum", headline: "Plums are a very nutritious fruit. An excellent source of vitamins, minerals, fiber and antioxidants.", image: "plum", gradientColor: [Color("ColorPlumLight"), Color("ColorPlumDark")],
        description: """
    ...
    Fruit(title: "Lime", headline: "Sour, round, and bright green citrus fruits. Limes are high in vitamin C, antioxidants, and other nutrients.", image: "lime", gradientColor: [Color("ColorLimeLight"), Color("ColorLimeDark")],
        description: """
    ...
    Fruit(title: "Pomegranate", headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.", image: "pomegranate", gradientColor: [Color("ColorPomegranateLight"), Color("ColorPomegranateDark")],
        description: """
    ...
    Fruit(title: "Pear", headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.", image: "pear", gradientColor: [Color("ColorPearLight"), Color("ColorPearDark")],
        description: """
    ...
    Fruit(title: "Gooseberry", headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.", image: "gooseberry", gradientColor: [Color("ColorGooseberryLight"), Color("ColorGooseberryDark")],
        description: """
      ...
      Fruit(title: "Mango", headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.", image: "mango", gradientColor: [Color("ColorMangoLight"), Color("ColorMangoDark")],
        description: """
    ...
    Fruit(title: "Watermelon", headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.", image: "watermelon", gradientColor: [Color("ColorWatermelonLight"), Color("ColorWatermelonDark")],
        description: """
    ...
    Fruit(title: "Cherry",headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",image: "cherry",gradientColor: [Color("ColorCherryLight"), Color("ColorCherryDark")],
        description: """
    ...
    Fruit(title: "Grapefruit", headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.", image: "grapefruit", gradientColor: [Color("ColorGrapefruitLight"), Color("ColorGrapefruitDark")],
        description: """
    ...
    Fruit(title: "Apple", headline: "Apples are one of the most popular, and exceptionally healthy fruit for good reason.", image: "apple", gradientColor: [Color("ColorAppleLight"), Color("ColorAppleDark")],
        description: """
